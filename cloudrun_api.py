...
app = FastAPI(title="NFL Analytics API", version="3.1")
MODEL_CACHE = {}
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "NFL Analytics Cloud Run", "version": "3.1"}
