...
app = FastAPI(title="NFL Analytics API", version="3.6")
MODEL_CACHE = {}
...
def candidate(game, pick, primary_prob, support_probs, odd_self, odd_other, bankroll=DEFAULT_BANKROLL,
    ...
    if p < MIN_PROBABILITY or edge < 3 or ev < 3:
        return None
    is_bet = odd < 0
